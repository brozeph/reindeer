...
module.exports = (function () {
		...
		Object.keys(model).forEach(function (fieldName) {
			var
				...
				if (Array.isArray(fieldValue)) {
					fieldValue.forEach(function (subValue, i) {
	...
	function validateModel (self, model, parentPath, skipRequiredFieldCheck) {
		...
		Object.keys(model).some(function (field) {
			...
			if (Array.isArray(fieldValue)) {
				return fieldValue.some(function (subValue, i) {
	...
	Mapper.prototype.analyzedFields = function () {
		...
		Object.keys(_this._fields).forEach(function (fieldPath) {
	...
	Mapper.prototype.bulkDelete = function (idList, callback) {
		...
		return ensureInitialize(_this, function (err) {
			...
			return _this._client.bulk(commands, function (err, summary) {
				if (err) {
					return callback(err);
				}
	...
	Mapper.prototype.delete = function (_id, callback) {
		...
		return ensureInitialize(_this, function (err) {
			...
			// delete by _id
			if (options._id) {
				return _this._client.delete(options, function (err, summary) {
					if (err) {
			...
			// delete by query
			return _this._client.deleteByQuery(options, function (err, summary) {
				if (err) {
